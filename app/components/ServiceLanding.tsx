...
export default function ServiceLanding({ content }: { content: ServiceLandingContent }) {
  ...
  return <main>
    ...
    <section className="landing-hero">
      <div className="landing-hero-copy"><p className="eyebrow"><i /> {content.eyebrow}</p><h1>{content.title}</h1><p>{content.summary}</p><div className="hero-actions"><a className="btn" href="/#schedule">Request service <span>↗</span></a><a className="btn-outline" href="tel:+12162536468">Call 216-253-6468 <span>→</span></a></div><div className="landing-trust"><span>✓ Licensed & insured</span><span>✓ License #28303</span><span>✓ Residential & commercial expertise</span></div></div>
    ...
    <section className="response-band"><strong>15-minute response target</strong><span>Website requests are typically reviewed within 15 minutes during regular business hours. For urgent service, call directly.</span><a href="tel:+12162536468">Call now →</a></section>
