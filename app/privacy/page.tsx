...
export default function PrivacyPage() {
  return <main>
    ...
    <article className="legal-content">
      ...
      <p>The assistant is not a technician and cannot inspect equipment, diagnose a condition, provide a binding price, book an appointment or dispatch emergency help. Do not enter payment-card numbers, Social Security numbers, medical information, account passwords or other sensitive information. Use the separate service-request form when you want to provide contact information for follow-up.</p>
      ...
      <p>Eternity uses service providers to host the website, operate the assistant, generate AI-assisted responses, deliver request and confirmation emails, protect the website from abuse and measure website activity. Those providers receive only the information needed to perform their role. Current website services include OpenAI Sites/Cloudflare infrastructure, Signmons for the automated assistant, OpenAI for AI-assisted responses, Resend for email delivery and Google Analytics for website measurement.</p>
