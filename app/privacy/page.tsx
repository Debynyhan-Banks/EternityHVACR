...
export default function PrivacyPage() {
  return <main>
    ...
    <article className="legal-content">
      ...
      <p>The Signmons-powered assistant offers guided routing and an optional AI-assisted conversation. When you start the conversation, the message you enter and a random session identifier are sent through Eternity&apos;s secured website service to Signmons. Signmons uses OpenAI to generate a response. Messages and responses may be stored in service logs and reviewed by Eternity for follow-up, quality, safety, abuse prevention and troubleshooting.</p>
      <p>When an eligible appointment is confirmed, the assistant may provide a private appointment-management link. That link acts as authorization to view, reschedule or cancel the associated appointment, so it should not be shared. The credential is kept out of the initial page request, is validated by Signmons and expires automatically. Appointment changes are sent to Eternity and update the dispatch calendar.</p>
      <p>The assistant is not a technician and cannot inspect equipment, diagnose a condition, provide a binding price or dispatch emergency help. For eligible residential heating or cooling diagnostics, it may show live availability and confirm the window you select. Other submissions remain requests for human follow-up. Do not enter payment-card numbers, Social Security numbers, medical information, account passwords or other sensitive information.</p>
      <p>Eternity may measure non-personal interaction categories—such as opening the assistant, starting a chat, selecting a service path or choosing a contact method—to improve the experience. Eternity does not intentionally send the contents of chat messages to Google Analytics.</p>
      ...
      <p>Eternity uses service providers to host the website, operate the assistant, generate AI-assisted responses, manage appointment availability, deliver request and confirmation emails, protect the website from abuse and measure website activity. Those providers receive only the information needed to perform their role. Current website services include OpenAI Sites/Cloudflare infrastructure, Signmons for the automated assistant, OpenAI for AI-assisted responses, Google Calendar for eligible appointment scheduling, Resend for email delivery and Google Analytics for website measurement.</p>

      <h2>Second-opinion files</h2>
      <p>If you request a second opinion, we collect the diagnosis, proposal or equipment images you choose to upload together with your contact information, service ZIP code and review request. Files are stored privately and are not given a public URL. Only approved Eternity owner/admin accounts may list or download an unexpired file.</p>
      <p>Second-opinion files and their private upload record expire after 30 days. Expired files cannot be accessed through the review workspace and are removed by the retention cleanup workflow. Do not upload payment-card numbers, Social Security numbers, medical information, account passwords or unrelated sensitive information.</p>

      <h2>Retention and security</h2>
      <p>Second-opinion uploads follow the specific 30-day limit above. We keep other service-request and assistant records only as long as reasonably needed for the purposes described here, to support an active customer relationship, operate and secure the services, or meet recordkeeping and legal obligations. Assistant conversation sessions are closed after inactivity, although associated service records may remain until they are no longer reasonably needed. No online system can guarantee absolute security, but Eternity limits collection, uses HTTPS, keeps integration credentials on the server and applies validation, rate limits and abuse controls.</p>
