  ...
  return <main>
    ...
    <section className="hero" id="top">
      ...
      <div className="hero-media">
        <img src="/images/hero-technician-black.jpg" alt="Black skilled trades professional servicing an electrical control system" width="1800" height="1202" fetchPriority="high" />
